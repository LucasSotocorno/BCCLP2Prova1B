...
export default function Candidato(props) {
        function curtirCandidato(candidato){
            candidato.curtidas =+ curtidas;
        }
        function nCurtirCandidato(candidato){
            candidato.descurtidas =+ descurtidas;
        }
    return (
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Button onClick={()=>{curtirCandidato();}} variant="primary"> {//Curtir
                                           }
                ...
                </Button> <Button onClick={()=>{nCurtirCandidato();}} variant="primary"> {//Não Curtir
                                           }
                ...
                <Button onClick={()=>{props.exibirCandidato(false)}} className="mt-1" variant="success">Conheça minhas propostas</Button>
            </Card.Body>
        </Card>
    );
}